...
<section class="auth bg-base d-flex flex-wrap">
    ...
    <div class="auth-right py-32 px-24 d-flex flex-column justify-content-center" style="margin: 0 auto;">
        <div class="max-w-500-px mx-auto w-100">
            <div>
                <a href="#" class="mb-40 max-w-200-px">
                    <img src="assets/images/logo.png" alt="" style="width: 200px;">
                </a>
                <h4 class="mb-12">Sign in to VSME Dashboard</h4>
                <p class="mb-32 text-secondary-light text-lg">Manage your ESG reporting and supplier relationships</p>
            </div>
             ...
             <form id="loginForm">
                ...
                <div class="">
                    <div class="d-flex justify-content-between gap-2">
                        <div class="form-check style-check d-flex align-items-center"></div>
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.status === 'success') {
                    ...
                    //$('#responseMessage').html('<div class="alert alert-success alert-dismissible fade show" role="alert">' + response.message + '</div>');
                   ...
                   //$('#responseMessage').html('<div class="alert alert-danger alert-dismissible fade show" role="alert">' + response.message + '</div>');
                }
            },
            error: function() {
                Swal.fire({
                ...
                //$('#responseMessage').html('<div class="alert alert-danger alert-dismissible fade show" role="alert">Error occurred while submitting the form.</div>');
            }
        });
    }
