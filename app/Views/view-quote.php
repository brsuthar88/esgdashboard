...
<body>
    ...
    <!-- Sidebar -->
    <?php $dataview = ['customerdata' => $customerdata,'categories' => $categories,'sellerdata' =>$sellerdata,'itemdata'=>$itemdata];
  ...
  <ul class="d-flex align-items-center gap-2">
    <li class="fw-medium"> <a href="/" class="d-flex align-items-center gap-1 hover-text-primary">
          ...
          Dashboard  </a> </li>
            <li>></li>
         <li class="fw-medium"> <a href="/list-quotation" class="d-flex align-items-center gap-1 hover-text-primary">List Quotation</a></li>
         <li>></li>
    ...
    <div class="card">
      <div class="card-header">
        <div class="d-flex flex-wrap align-items-center justify-content-end gap-2">
          <a  href="#" onclick="confirmMailSend('/send-detail-mail/<?=esc($itemdata['mainquot'][0]['quotation_id']);?>')" class="btn btn-sm btn-primary-600 radius-8 d-inline-flex align-items-center gap-1">
            <iconify-icon icon="pepicons-pencil:paper-plane" class="text-xl"></iconify-icon>
            Send Quotation
          </a>
          <a href="/generate-pdf/<?=esc($itemdata['mainquot'][0]['quotation_id']);?>" class="btn btn-sm btn-warning radius-8 d-inline-flex align-items-center gap-1">
      ...
      <div class="card-body py-40">
        <div class="row justify-content-center" id="invoice">
          ...
          <?php if($itemdata['mainquot'][0]['comment']) { ?>
               <div class="col-lg-4" style="font-size:14px;display:none">
                   <?php
