        ...
        <form id="updateProfile">
          <div class="row gy-3">
            <div class="mb-20 col-sm-6">
              ...
              <input type="text" class="form-control radius-8" id="fname" name="fname" placeholder="Enter First Name" Value="<?=$sellerdata['first_name'];?>" data-rule-required="true" data-msg-required="First Name is required.">
            </div>
            <div class="mb-20 col-sm-6">
              ...
              <input type="text" class="form-control radius-8" id="lname" name="lname" placeholder="Enter Last Name" Value="<?= $sellerdata['last_name'];?>" data-rule-required="true" data-msg-required="Last Name is required.">
            </div>
            <div class="mb-20 col-sm-6">
              <label for="email" class="form-label fw-semibold text-primary-light text-sm mb-8">Email <span class="text-danger-600">*</span></label>
              <input type="email" class="form-control radius-8" id="email" name="email" placeholder="Enter Email" Value="<?= $sellerdata['email'];?>" data-rule-required="true" data-msg-required="Email is required."  data-rule-email="true" data-msg-email="Enter a valid email address.">
            </div>
            <div class="mb-20 col-sm-6">
              <label for="number" class="form-label fw-semibold text-primary-light text-sm mb-8">Phone</label>
              <input type="text" class="form-control radius-8" id="number" name="number" placeholder="Enter phone number" Value="<?= $sellerdata['phone_number'];?>" data-rule-phoneau="true"  data-msg-phoneau="Please enter a valid phone number (e.g., +1 123 456 7890,1-123-456-7890,(123) 456-7890,123-456-7890,123.456.7890,1234567890).">
            </div>
            <div class="mb-20">
              <label for="desc" class="form-label fw-semibold text-primary-light text-sm mb-8">Description</label>
              <textarea name="#0" class="form-control radius-8" id="desc" placeholder="Write description..."><?= $sellerdata['description'];?></textarea>
            </div>
          </div>
        </form>
      </div>
        ...
        <form id="updatePassword">
          <div class="row gy-3">
            ...
            <div class="mb-20">
              ...
              <div class="position-relative">
                <input type="password" class="form-control radius-8" id="confirm-password" placeholder="Confirm Password*" name="confirm-password" placeholder="Confirm Password*"  data-rule-required="true" data-msg-required="Please confirm your password." data-rule-equalto="#your-password"  data-msg-equalto="Passwords do not match.">
...
Swal.fire({
        ...
        // AJAX request
        $.ajax({
            url: '<?= base_url('/seller/update-profile') ?>',
            type: 'POST',
            data: formData,
            dataType: 'json',
...
<script>
 ...
 Swal.fire({
        ...
        // AJAX request
        $.ajax({
            url: '<?= base_url('/seller/update-profile-passwordword') ?>',
            type: 'POST',
            data: formData,
            dataType: 'json',
            success: function(response) {
