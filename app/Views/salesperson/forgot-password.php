...
<section class="auth forgot-password-page bg-base d-flex flex-wrap">  
    <!--<div class="auth-left d-lg-block d-none">
        <div class="d-flex align-items-center flex-column h-100 justify-content-center">
            <img src="../assets/images/auth/auth-img.png" alt="" style="width: 270px;">
        </div>
    </div>-->
    <div class="auth-right py-32 px-24 d-flex flex-column justify-content-center" style="margin: 0 auto;">
        ...
        <div class="max-w-500-px mx-auto w-100">
            ...
            <form id="forgot" action="<?= site_url('/seller/send-password') ?>" method="post">
                ...
                <div class="text-center">
                    <a href="/seller/login" class="text-primary-600 fw-bold mt-24">Back to Sign In</a>
                </div>
                
                <div class="mt-120 text-center text-sm">
                    <p class="mb-0">Already have an account? <a href="/seller/login" class="text-primary-600 fw-semibold">Sign In</a></p>
                </div>
            </form>
        </div>
    </div>
