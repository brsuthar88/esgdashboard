...
<body>
  ...
  <div class="dashboard-main-body">
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
      <h6 class="fw-semibold mb-0">Add Customer</h6>
 ...
 <form id="myForm">
      <div class="card-body p-24 pt-10">
            <div class="row gy-3">
              <div class="mb-20 col-sm-6">
                ...
                <input type="text" class="form-control radius-8" id="fname" name="fname" placeholder="Enter First Name"  data-rule-required="true" data-msg-required="First Name is required.">
              </div>
              <div class="mb-20 col-sm-6">
                ...
                <input type="text" class="form-control radius-8" id="lname" name="lname" placeholder="Enter Last Name" data-rule-required="true" data-msg-required="Last Name is required.">
              </div>
              <div class="mb-20 col-sm-6">
                <label for="email" class="form-label fw-semibold text-primary-light text-sm mb-8">Email <span class="text-danger-600">*</span></label>
                <input type="email" class="form-control radius-8" id="email" placeholder="Enter Email" name="email" data-rule-required="true" data-msg-required="Email is required."  data-rule-email="true" data-msg-email="Enter a valid email address.">
              </div>
              <div class="mb-20 col-sm-6">
                <label for="number" class="form-label fw-semibold text-primary-light text-sm mb-8">Phone</label>
                <input type="text" class="form-control radius-8" id="number" name="number" placeholder="Enter phone number" data-rule-phoneau="true"  data-msg-phoneau="Please enter a valid phone number (e.g., +1 123 456 7890,1-123-456-7890,(123) 456-7890,123-456-7890,123.456.7890,1234567890).">
              </div>
              <div class="mb-20 col-sm-6">
                ...
                <?php foreach ($custocate as $catrow):?>
            ...
            <div class="row gy-3">
              <div class="col-md-6">
                ...
                <div class="row gy-3">
                   ...
                   <textarea name="baddress" class="form-control radius-8" id="baddress" placeholder="Address" data-rule-required="true" data-msg-required="Address is required."></textarea>
                  </div>
                  <div class="col-12">
                    <label class="form-label">City <span class="text-danger-600">*</span></label>
                    <input type="text" name="bcity" class="form-control" id="bcity"  placeholder="City"  data-rule-required="true" data-msg-required="City is required.">
                  </div>
					   <div class="col-12">
                    <label class="form-label">State <span class="text-danger-600">*</span></label>
                    <input type="text" name="bstate" class="form-control" id="bstate"  placeholder="State"  data-rule-required="true" data-msg-required="State is required.">
                  </div>
					   <div class="col-12">
                    <label class="form-label">Zip Code <span class="text-danger-600">*</span></label>
                    <input type="text" name="bzip" class="form-control" id="bzip"  placeholder="Zip Code" data-msg-rangelength="Please enter a valid 5-digit zip code." data-rule-rangelength="5,5" data-rule-digits="true" data-rule-required="true" data-msg-required="Zip Code is required.">
                  </div>
                   
                  <div class="col-12">
                    <label class="form-label">Phone <span class="text-danger-600">*</span></label>
                   <input type="text" name="bphone" class="form-control" id="bphone"  placeholder="Phone"  data-rule-phoneau="true"  data-msg-phoneau="Please enter a valid phone number (e.g., +1 123 456 7890,1-123-456-7890,(123) 456-7890,123-456-7890,123.456.7890,1234567890)." data-rule-required="true" data-msg-required="Phone is required.">
        ...
        Copy Billing Address </a>)
                ...
                <div class="row gy-3">
                  ...
                  <div class="col-12">
                    <label class="form-label">Address <span class="text-danger-600">*</span></label>
                   <textarea name="saddress" class="form-control radius-8" id="saddress" placeholder="Address" data-rule-required="true" data-msg-required="Address is required."></textarea>
                  </div>
                  <div class="col-12">
                    <label class="form-label">City <span class="text-danger-600">*</span></label>
                    <input type="text" name="scity" class="form-control" id="scity" placeholder="City"  data-rule-required="true" data-msg-required="City is required.">
                  </div>
					   <div class="col-12">
                    <label class="form-label">State <span class="text-danger-600">*</span></label>
                    <input type="text" name="sstate" class="form-control" id="sstate" placeholder="State" data-rule-required="true" data-msg-required="State is required.">
                  </div>
					   <div class="col-12">
                    <label class="form-label">Zip Code <span class="text-danger-600">*</span></label>
                    <input type="text" name="szip" class="form-control" id="szip" placeholder="Zip Code" data-msg-rangelength="Please enter a valid 5-digit zip code." data-rule-rangelength="5,5" data-rule-digits="true" data-rule-required="true" data-msg-required="Zip Code is required.">
                  </div>
                  
                  <div class="col-12">
                    <label class="form-label">Phone <span class="text-danger-600">*</span></label>
                   <input type="text" name="sphone" class="form-control" id="sphone" placeholder="Phone" data-rule-phoneau="true"  data-msg-phoneau="Please enter a valid phone number (e.g., +1 123 456 7890,1-123-456-7890,(123) 456-7890,123-456-7890,123.456.7890,1234567890)." data-rule-required="true" data-msg-required="Phone is required.">
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="card-footer">
        <div class="d-flex flex-wrap align-items-center justify-content-end gap-2"> <a href="javascript:void(0)" id="submitdata" class="btn btn-sm btn-info-600 radius-8 d-inline-flex align-items-center gap-1">
          ...
          Save </a> <a href="javascript:void(0)" id="submitdatasend" class="btn btn-sm btn-primary-600 radius-8 d-inline-flex align-items-center gap-1">
          <iconify-icon icon="pepicons-pencil:paper-plane" class="text-xl"></iconify-icon>
          Save & Send Details </a> <a  href="#" onclick="resetpages('/seller/add-customer')"   class="btn btn-sm btn-warning radius-8 d-inline-flex align-items-center gap-1">
...
$("#myForm").validate({
  ...
  $("#submitdata").on("click", function () {
    ...
    if ($("#myForm").valid()) {
        ...
        // AJAX request
        $.ajax({
            url: '<?= base_url('/seller/save-customer') ?>',
            type: 'POST',
            data: formData,
            dataType: 'json',
...
<script>
    ...
    if ($("#myForm").valid()) {
        ...
        // AJAX request
        $.ajax({
            url: '<?= base_url('/seller/save-send-customer') ?>',
            type: 'POST',
            data: formData,
            dataType: 'json',
            success: function(response) {
...
<script>
    $(document).ready(function() {
     ...
     $("#sidebar-menu .customeradd").addClass('active-page');
    });
</script>
</body>
</html>