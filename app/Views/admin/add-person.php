...
<body>
 ...
 <div class="dashboard-main-body">
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
      <h6 class="fw-semibold mb-0">Add Sales Person</h6>
    ...
    <div class="card h-100 p-0 radius-12">
      <div class="card-body">
          ...
          <div class="row gy-3">
            ...
            <div class="mb-20 col-sm-6">
              ...
              <input type="email" class="form-control radius-8" id="email" name="email" placeholder="Enter Email" data-rule-required="true" data-msg-required="Email is required."  data-rule-email="true" data-msg-email="Enter a valid email address.">
            </div>
            <div class="mb-20 col-sm-6">
              <label for="number" class="form-label fw-semibold text-primary-light text-sm mb-8">Phone</label>
              <input type="text" class="form-control radius-8" id="number" ame="number" placeholder="Enter phone number" data-rule-phoneau="true"  data-msg-phoneau="Please enter a valid phone number (e.g., +1 123 456 7890,1-123-456-7890,(123) 456-7890,123-456-7890,123.456.7890,1234567890).">
            </div>
            <div class="mb-20 col-sm-6">
              ...
              <select class="form-control radius-8 form-select" id="desig" name="desig" data-rule-required="true" data-msg-required="Status is required.">
      ...
      <div class="card-footer">
        <div class="d-flex flex-wrap align-items-center justify-content-end gap-2">
          ...
          <a href="javascript:void(0)" id="submitdatasend"  class="btn btn-sm btn-primary-600 radius-8 d-inline-flex align-items-center gap-1">
            <iconify-icon icon="pepicons-pencil:paper-plane" class="text-xl"></iconify-icon>
            Save & Send Details
          </a>
          
			<a href="#" onclick="resetpages('/admin/add-person')" class="btn btn-sm btn-warning radius-8 d-inline-flex align-items-center gap-1">
...
$(document).ready(function () 
{
    ...
    $("#submitdata").on("click", function () 
    {
        if ($("#myForm").valid()) 
        {
            ...
            {
                title: "Are you sure?",
                text: "You want to save this sales person?",
                icon: "warning",
            ...
            }).then((result) => 
        {
            if (result.isConfirmed) 
            {
                ...
                $.ajax(
                {
                    url: '<?= base_url('/admin/save-person') ?>',
                    type: 'POST',
                    data: formData,
                    dataType: 'json',
...
$("#submitdatasend").on("click", function () 
{
    if ($("#myForm").valid()) 
    {
        ...
        {
            title: "Are you sure?",
            text: "You want to save and send this sales person?",
            icon: "warning",
            showCancelButton: true,
            confirmButtonColor: "#d33",
            cancelButtonColor: "#3085d6",
        ...
        }).then((result) => 
        {
            if (result.isConfirmed) 
            {
                ...
                $.ajax(
                {
                    url: '<?= base_url('/admin/save-send-person') ?>',
                    type: 'POST',
                    data: formData,
                    dataType: 'json',
                    success: function(response) 
...
<script>
    $(document).ready(function() {
     ...
     $("#sidebar-menu .selleradd").addClass('active-page');
    });
</script>
</body>
</html>