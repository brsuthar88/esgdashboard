  ...
  <div class="dashboard-main-body">
    ...
    <div class="card h-100 p-0 radius-12 mb-20">
        ...
        <form id="updateProfile">
          <div class="row gy-3">
            <div class="mb-20 col-sm-6">
              ...
              <input type="text" class="form-control radius-8" id="fname" name="fname" placeholder="Enter First Name" Value="<?=$admindata['first_name'];?>" data-rule-required="true" data-msg-required="First Name is required.">
            </div>
            <div class="mb-20 col-sm-6">
              ...
              <input type="text" class="form-control radius-8" name="lname" id="lname" placeholder="Enter Last Name" Value="<?= $admindata['last_name'];?>" data-rule-required="true" data-msg-required="Last Name is required.">
            </div>
            <div class="mb-20 col-sm-6">
              <label for="email" class="form-label fw-semibold text-primary-light text-sm mb-8">Email <span class="text-danger-600">*</span></label>
              <input type="email" name="email" class="form-control radius-8" id="email" placeholder="Enter Email" Value="<?= $admindata['email'];?>" data-rule-required="true" data-msg-required="Email is required."  data-rule-email="true" data-msg-email="Enter a valid email address.">
            </div>
            <div class="mb-20 col-sm-6">
              <label for="number" class="form-label fw-semibold text-primary-light text-sm mb-8">Phone</label>
              <input type="number" class="form-control radius-8" name="number" id="number" placeholder="Enter phone number" Value="<?= $admindata['phone_number'];?>" data-rule-phoneau="true"  data-msg-phoneau="Please enter a valid phone number (e.g., +1 123 456 7890,1-123-456-7890,(123) 456-7890,123-456-7890,123.456.7890,1234567890).">
            </div>
            <div class="mb-20">
              <label for="desc" class="form-label fw-semibold text-primary-light text-sm mb-8">Description</label>
              <textarea name="#0" class="form-control radius-8" id="desc" placeholder="Write description..."><?= $admindata['description'];?></textarea>
            </div>
          </div>
        </form>
      </div>
      <div class="card-footer">
        ...
        <button id="submitdata" class="btn btn-sm btn-info-600 radius-8 d-inline-flex align-items-center gap-1">
          ...
          <div class="row gy-3">
            <div class="mb-20">
              ...
              <div class="position-relative">
                <input type="password" class="form-control radius-8" id="your-password" name="your-password" placeholder="Enter New Password*" data-rule-required="true" data-msg-required="Password is required."
 >
            ...
            <div class="mb-20">
              ...
              <div class="position-relative">
                <input type="password" class="form-control radius-8" name="confirm-password" id="confirm-password" placeholder="Confirm Password*" data-rule-required="true" data-msg-required="Please confirm your password." data-rule-equalto="#your-password"  data-msg-equalto="Passwords do not match.">
...
$(document).ready(function () {
 ...
 Swal.fire({
        ...
        // AJAX request
        $.ajax({
            url: '<?= base_url('/admin/update-profile-password') ?>',
            type: 'POST',
            data: formData,
            dataType: 'json',
            success: function(response) {
