    ...
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
      ...
      <ul class="d-flex align-items-center gap-2">
        <li class="fw-medium"> <a href="/admin" class="d-flex align-items-center gap-1 hover-text-primary">
          ...
          Dashboard  </a> </li>
            <li>></li>
         <li class="fw-medium"> <a href="/admin/list-customer" class="d-flex align-items-center gap-1 hover-text-primary">List Customers</a></li>
         <li>></li>
    ...
    <div class="card p-0 overflow-hidden position-relative radius-12 h-100">
              ...
              <div class="mb-20 col-sm-6">
                ...
                <select class="form-control radius-8 form-select" id="sellerid" name="sellerid" data-rule-required="true" data-msg-required="Sales Person is required.">
                   <?php
                    ...
                    <?php if($customerdata['sales_person_id'] == $selrow['sales_person_id']) { ?>
                      <option selected="selected" value="<?= $selrow['sales_person_id'];?>"><?=$selrow['first_name'];?> <?= $selrow['last_name'];?> </option>
                    <?php } else { ?>
      ...
      <div class="card-footer">
        <div class="d-flex flex-wrap align-items-center justify-content-end gap-2"> <a href="javascript:void(0)" id="submitdata" class="btn btn-sm btn-info-600 radius-8 d-inline-flex align-items-center gap-1">
          ...
          Update </a>  <a href="#" onclick="resetpages('/admin/edit-customer/<?= isset($customerdata['customer_id']) ? htmlspecialchars($customerdata['customer_id']) : '' ?>')" class="btn btn-sm btn-warning radius-8 d-inline-flex align-items-center gap-1">
