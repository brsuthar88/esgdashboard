  ...
  <div class="dashboard-main-body">
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
      ...
      <ul class="d-flex align-items-center gap-2">
        <li class="fw-medium"> <a href="/admin" class="d-flex align-items-center gap-1 hover-text-primary">
          ...
          Dashboard  </a> </li>
            <li>></li>
         <li class="fw-medium"> <a href="/admin/list-user" class="d-flex align-items-center gap-1 hover-text-primary">List User</a></li>
         <li>></li>
    ...
    <div class="card p-0 overflow-hidden position-relative radius-12 h-100">
      <div class="card-header pt-16 pb-0 px-24 bg-base border border-end-0 border-start-0 border-top-0 d-flex align-items-center flex-wrap justify-content-between">
        <h6 class="text-lg mb-0"> User Details</h6>
      </div>
      <form id="myForm">
      <div class="card-body p-24 pt-10">
            <div class="row gy-3">
              <div class="mb-20 col-sm-6">
                ...
                <input type="text" class="form-control radius-8" id="fname" name="fname" placeholder="Enter First Name"  data-rule-required="true" data-msg-required="First Name is required." value="<?= isset($userlist['first_name']) ? htmlspecialchars($userlist['first_name']) : '' ?>">
              </div>
              <div class="mb-20 col-sm-6">
                ...
                <input type="text" class="form-control radius-8" id="lname" name="lname" placeholder="Enter Last Name" data-rule-required="true" data-msg-required="Last Name is required." value="<?= isset($userlist['last_name']) ? htmlspecialchars($userlist['last_name']) : '' ?>">
              </div>
              <div class="mb-20 col-sm-6">
                <label for="email" class="form-label fw-semibold text-primary-light text-sm mb-8">Email <span class="text-danger-600">*</span></label>
                <input type="email" class="form-control radius-8" id="email" name="email" placeholder="Enter Email" data-rule-required="true" data-msg-required="Email is required."  data-rule-email="true" data-msg-email="Enter a valid email address." value="<?= isset($userlist['email']) ? htmlspecialchars($userlist['email']) : '' ?>">
              </div>
              <div class="mb-20 col-sm-6">
                <label for="number" class="form-label fw-semibold text-primary-light text-sm mb-8">Phone</label>
                <input type="text" class="form-control radius-8" id="number" name="number" placeholder="Enter phone number" data-rule-phoneau="true"  data-msg-phoneau="Please enter a valid phone number (e.g., +1 123 456 7890,1-123-456-7890,(123) 456-7890,123-456-7890,123.456.7890,1234567890)." value="<?= isset($userlist['phone_number']) ? htmlspecialchars($userlist['phone_number']) : '' ?>">
              </div>
              <div class="mb-20 col-sm-6">
                ...
                <select class="form-control radius-8 form-select" id="destatus"  name=
              ...
              <div class="mb-20 col-sm-6">
                ...
                <textarea name="#0" class="form-control radius-8" id="desc" placeholder="Write description..."><?= isset($userlist['description']) ? htmlspecialchars($userlist['description']) : '' ?></textarea>
              </div>
            </div>
            <input type="hidden" id="adminid" value="<?= isset($userlist['admin_id']) ? htmlspecialchars($userlist['admin_id']) : '' ?>">
      ...
      <div class="card-footer">
        <div class="d-flex flex-wrap align-items-center justify-content-end gap-2"> <a href="javascript:void(0)" id="submitdata" class="btn btn-sm btn-info-600 radius-8 d-inline-flex align-items-center gap-1">
          ...
          Update </a>  <a href="#" onclick="resetpages('/admin/edit-user/<?= isset($userlist['admin_id']) ? htmlspecialchars($userlist['admin_id']) : '' ?>')" class="btn btn-sm btn-warning radius-8 d-inline-flex align-items-center gap-1">
...
<script>
 ...
 <?php if($userlist == "error"){ ?>
<script>
    Swal.fire({
        icon: "error",
        title: "Oops...",
        text: "Your user has been removed. Please contact the administrator.",
        timer: 5000,
