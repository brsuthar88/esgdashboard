...
?>
  ...
  <ul class="d-flex align-items-center gap-2">
        <li class="fw-medium"> <a href="/admin" class="d-flex align-items-center gap-1 hover-text-primary">
          ...
          Dashboard </a> </li>
        <li>></li>
        <li class="fw-medium">Quotation</li>
         <li class="fw-medium">></li>
         <li class="fw-medium"> <a href="/admin/list-quotation" class="d-flex align-items-center gap-1 hover-text-primary">List Quotation</a></li>
      </ul>
</div>
    ...
    <div class="card">
      <div class="card-header">
        <div class="d-flex flex-wrap align-items-center justify-content-end gap-2">
          <a  href="#" onclick="confirmMailSend('/admin/send-detail-mail/<?=esc($itemdata['mainquot'][0]['quotation_id']);?>')" class="btn btn-sm btn-primary-600 radius-8 d-inline-flex align-items-center gap-1">
            <iconify-icon icon="pepicons-pencil:paper-plane" class="text-xl"></iconify-icon>
            Send Quotation
          </a>
          <a href="/admin/generate-pdf/<?=esc($itemdata['mainquot'][0]['quotation_id']);?>" class="btn btn-sm btn-warning radius-8 d-inline-flex align-items-center gap-1">
            ...
            <div class="shadow-4 border radius-8">
              <div class="p-20 d-flex flex-wrap justify-content-between gap-3 border-bottom">
                 <div>
                  ...
                  <p class="mb-1 text-sm"><strong>Status:</strong> <?=$itemdata['mainquot'][0]['status'];?></p>
                </div>
              ...
              <div class="py-28 px-20">
                ...
                <div class="mt-24">
                  <div class="table-responsive scroll-sm">
                    ...
                    <th scope="col" class="text-start" width="30%">Item & Description</th>
...
foreach ($itemdata['quotitem'] as $itemdatas) {?>
                        ...
                        <tr>
                          ...
                          <td class="text-start" width="30%"><?=$itemdatas['item_name'];?><br><span style="font-size: 12px"><strong>SKU:</strong><?=$itemdatas['item_sku'];?></span><br><span style="font-size: 12px"><?=$itemdatas['item_description'];?></span></td>
                          <td class="text-center"><?=$itemdatas['item_unit'];?></td>
                          <td  class="text-end"><?= $GLOBALS['currencysymbol'];?><?=$itemdatas['amount'];?></td>
                          <td class="text-center"><?=$itemdatas['quantity'];?></td>
                ...
                <div class="mt-64">
                  <p class="text-left text-secondary-light" style="font-size: 12px"><strong>Terms &amp; Conditions</strong><br><br>
                    1. Product Certification: HAVELLS exclusively stock/sell UL/ETL certified products.<br>
                    2. Sales Tax: We collect sales tax only for the state of South Carolina (SC). Customers in all other states are responsible for their own sales and use tax filings and payments. Havells Lighting is not responsible or liable for any sales taxes collected or paid in states other than SC.<br>
                    3. Additional Certification: All our products are Energy Star or DLC certified (available for certification with ES/DLC) and are eligible for Energy Company Rebate programs.<br>
                    4. Warranty: Our lights are guaranteed for 2-5 years, subject to inspection prior to replacement. &quot;HAVELLS&quot; is not responsible for replacing lights that fail due to abnormal use or misuse of the products. In cases where the product is discontinued, &quot;HAVELLS&quot; will replace it with the current equivalent product.</p>
                </div>
