...
<body>
    <!-- Sidebar -->
    <?php $dataview = ['admindata' => $admindata,'settingdata'=>$settingdata];
      ...
      <div class="col-lg-4">
        ...
        <div class="card-box">
          ...
          <div class="form-check">
            <input class="form-check-input" type="checkbox" id="logoExport">
            <label class="form-check-label" for="logoExport">Include company logo in PDF exports</label>
          </div>
          <div class="form-check">
            <input class="form-check-input" type="checkbox" id="customColors">
            <label class="form-check-label" for="customColors">Use custom colors in dashboard tiles</label>
          </div>
          <div class="form-check">
            <input class="form-check-input" type="checkbox" id="showCompanyName">
